export const metadata = {
  title: "Installation - FormCN Documentation",
  description: "How to install and set up FormCN in your project.",
};

# Installation

Get started with FormCN in your Next.js or React project.
...
FormCN forms are built on top of shadcn/ui. If you haven't already, initialize it:
...
Now that you have FormCN installed, check out the [Quick Start](/docs/quick-start) guide to build your first form.
