...
- **Better Auth Integrated**: Full authentication support (OAuth, Email/Password, 2FA, Magic Links, Passkeys, Organizations) out of the box
...
- **Interactive Setup Guide**: Step-by-step checklist for backend integration (secret generation, schema migrations, etc.)
...
- **Authentication**: Login, Signup, 2FA Setup, and Passkey Management
- **Organization**: Multi-tenant invitation forms and member management
