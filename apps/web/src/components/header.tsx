...
export default function Header() {
  ...
  const links = [
    ...
    { to: "/demo/form-registry", label: "Formscn Package" },
    { to: "/editor", label: "Visual Editor" },
  ] as const;

  return (
    <header className="sticky top-0 z-50 w-full border-b border-white/5 bg-black/60 backdrop-blur-xl supports-[backdrop-filter]:bg-black/40 px-4 md:px-2">
